...
const Store: React.FC<StoreProps> = ({ onOpenDrop, onOpenCollection, onOpenCart, onAddToCart }) => {
  ...
  return (
    <div className="p-6 pb-32">
      ...
      <button 
        onClick={onOpenDrop}
        className="w-full bg-primary rounded-[2.5rem] p-6 mb-10 text-left text-white shadow-[0_0_30px_rgba(95,61,148,0.3)] hover:scale-[1.02] active:scale-[0.98] transition-all relative overflow-hidden group"
      >
            ...
            <div className="px-2 pb-2">
               ...
               <div className="flex justify-between items-center">
                 ...
                 <button 
                  ...
                  className="bg-primary text-white p-2 rounded-2xl shadow-lg active:scale-90 transition-transform"
                 >
